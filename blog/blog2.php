...
<body>
	...
	<div class="row">
            ...
            <h2>Bài Viết 2: Lựa Chọn Bàn Ghế Phù Hợp Cho Phòng Ăn</h2>
            <p class="date"><?php echo date("d/m/Y"); ?></p>
        </section>
        <section class="post-detail">
            <img src="../images/post-2.jpg" alt="Lựa chọn bàn ghế cho phòng ăn">
            <p>Phòng ăn là nơi gia đình quây quần bên nhau. Chọn lựa bàn ghế phù hợp sẽ tạo nên không gian ấm cúng và thoải mái. Trong bài viết này, chúng tôi sẽ hướng dẫn bạn cách chọn bàn ghế phù hợp với không gian phòng ăn, phong cách nội thất và nhu cầu sử dụng của gia đình.</p>
            <p>...</p>
        </section>
