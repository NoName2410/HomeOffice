...
<body>
	...
	<div class="row">
            ...
            <h2>Bài Viết 3: Sắp xếp nội thất cho những căn phòng nhỏ</h2>
            <p class="date"><?php echo date("d/m/Y"); ?></p>
        </section>
        <section class="post-detail">
            <img src="../images/post-3.jpg" alt="Lựa chọn bàn ghế cho phòng ăn">
            <p>Hiện nay xu hướng sử dụng những căn nhà nhỏ tiện nghi đang được nhiều bạn trẻ ưa thích.Trang này chúng tôi xin cung cấp cho bạn những mẹo hay để ...</p>
            <p>...</p>
        </section>
